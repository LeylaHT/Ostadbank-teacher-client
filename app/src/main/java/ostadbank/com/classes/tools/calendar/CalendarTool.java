 ...
 * getJulianDay(); String getIranianDateYMD(); String getGregorianDate(); String
...
public class CalendarTool {
	...
	public String getIranianMonthName() {
		...
		String MonthOfYear[] = { "فروردین", "اردیبهشت", "خرداد", "تیر",
				"مرداد", "شهریور", "مهر" ,"آبان","آذر","دی","بهمن","اسفند"};
		return (MonthOfYear[irMonth-1]);
	}
	...
	/**
	 * getIranianDateYMD: Returns a string version of Iranian date MD
	 * 
	 * @return String
	 */
	public String getIranianDateYMD() {
	 ...
	 * @return String
	 */
	public String getIranianDateMD() {
